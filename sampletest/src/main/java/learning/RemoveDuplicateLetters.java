...
//https://leetcode.com/problems/remove-duplicate-letters/
	...
	public static String removeDuplicateLetters(String s) {
		...
		for (char c: ch) // count number of occurance of character
			res[c-'a']++;
		...
		for (char c: ch) {
			...
			// it can be removed and added later e.g stack =bc remaining stack abc then a can pop b and then c
	...
	public static void main(String[] args) {
		System.out.println(removeDuplicateLetters("cbacdcabc"));
	}
}
